...
class MockTestMain : AppCompatActivity(){
    ...
    override fun onCreate(savedInstanceState: Bundle?){
        ...
        var test_num = intent.getIntExtra("test_num", 0)
        ...
        tvMainTopTitle.setText("모의고사 ${test_num}회")


        //1번 선택했을 때
        tvChoice1.setOnClickListener {
            isQuestionResult(tvChoice1, pr_num, "1")
        }
        //2번 선택했을 때
        tvChoice2.setOnClickListener {
            isQuestionResult(tvChoice2, pr_num,"2")
        }
        //3번 선택했을 때
        tvChoice3.setOnClickListener {
            isQuestionResult(tvChoice3, pr_num,"3")
        }
        //4번 선택했을 때
        tvChoice4.setOnClickListener {
            isQuestionResult(tvChoice4, pr_num,"4")
        }
        //다음 문제로 넘어가기
